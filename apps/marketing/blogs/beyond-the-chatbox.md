...
The hardest part isn’t generating words. It’s _running the loop_.
...
2. translate that into a prompt, and
3. provide enough context data for the model to respond correctly.
