...
Once started, the Loop writes new decisions to `~/.openloomi/skills/openloomi-loop/data/decisions.json`. OpenLoomi's own Loop panel surfaces them as cards — type badge, confidence bar, triggering context, memory refs, suggested action — and lets you `▶ RUN`, `✓ DONE`, or `✕ DISMISS` without leaving the app.

```
┌─────────────────────────────────────────────────────────────────┐
│  Q · Queue                                3 pending · 1 done   │
├─────────────────────────────────────────────────────────────────┤
│  🟠 rsvp           0.85     ⏰ Tomorrow 15:00                    │
│     RSVP: Q2 Roadmap Review                                     │
│     👤 Sarah Chen  🧠 people/sarah_chen.md, projects/q2.md      │
│     → calendar_rsvp · accepted                                  │
│     [ ▶ RUN ]  [ ✓ DONE ]  [ ✕ DISMISS ]                       │
├─────────────────────────────────────────────────────────────────┤
│  🟢 draft_reply    0.85     ✉️ 2h ago                           │
│     Reply: Q2 review tomorrow please RSVP                       │
│     👤 Sarah Chen  🧠 people/sarah_chen.md                      │
│     → email_reply · thread_id=t1                                │
└─────────────────────────────────────────────────────────────────┘
```
