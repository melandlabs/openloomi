...
type NativePermissionRequest = Parameters<
  NonNullable<NativeAgentRunnerContext["permissionHandler"]>
>[0];

type NativePermissionDecision = Awaited<
  ReturnType<NonNullable<NativeAgentRunnerContext["permissionHandler"]>>
>;
