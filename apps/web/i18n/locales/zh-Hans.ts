...
const zh = {
  ...
  settings: {
    ...
    llmUsageTitle: "API 用量",
    llmUsageLocalBadge: "本地统计",
    llmUsageLoading: "正在加载用量…",
    llmUsageUnconfigured: "保存一个模型提供商配置后开始统计 token 用量。",
    llmUsageError: "暂时无法获取用量数据。",
    llmUsageProvider: "当前提供商",
    llmUsageRequests: "请求次数",
    llmUsageTokens: "Token 总数",
    llmUsageTokensIn: "输入",
    llmUsageTokensOut: "输出",
    llmUsageLastActivity: "最近活动",
    llmUsageFootnote:
      "用量由 OpenLoomi 本地记录，可能不包含在提供商返回用量前失败的请求。实际消费以提供商账单页面为准。",
