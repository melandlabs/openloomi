...
The desktop installers include `openloomi-ctl` for scripted one-shot usage from the installed app resources. See [OpenLoomi CLI](./docs/openloomi-ctl.md) for bundled CLI paths, CI/CD, and `--one-shot --json` usage.
