...
Standalone CLI release artifacts are published on the release page as `openloomi-ctl-windows-x64.zip`, `openloomi-ctl-macos-arm64.tar.gz`, `openloomi-ctl-macos-x64.tar.gz`, `openloomi-ctl-linux-x64.tar.gz`, and `openloomi-ctl-linux-arm64.tar.gz`. See [OpenLoomi CLI](./docs/openloomi-ctl.md) for download, CI/CD, and `--one-shot --json` usage.
